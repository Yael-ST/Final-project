...
namespace MyProject.Classes
{
    internal class IsoscelesTriangle : Triangle
    {
        ...
        public string[] find_names_of_base_angles()
        {
            ...
            angels[0] = this.nameShok1[0].ToString() + this.nameShok1[1].ToString() + this.nameShok2[1].ToString(); 
            angels[1] = this.nameShok2[0].ToString() + this.nameShok2[1].ToString() + this.NameShok1[1].ToString(); 
